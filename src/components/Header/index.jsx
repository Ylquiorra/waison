...
import { setOpenCartPopup, setOpenBurger } from '../../redux/clickOutside/slice';
import Search from '../Search';
import PopupCart from './PopupCart';
import AppContext from '../../context';

const Header = () => {
  const { openCartPopup, openBurger } = useSelector((state) => state.clickOutsideSlice);
  const dispatch = useDispatch();
  const { burgerRef, iconCartPopupRef, iconBurgerRef } = React.useContext(AppContext);

  const onClickToLinks = () => dispatch(setOpenBurger(false));
  return (
    <>
      <section
        ref={burgerRef}
        ...
        <div className="burger-menu__small-container">
          <div className="burger-menu__body">
            <div onClick={() => dispatch(setOpenBurger(false))} className="body-menu__close">
              Close
            </div>
            ...
            <div className="header__nav">
              ...
              <div className="nav-header__right-menu">
                ...
                <div
                  ...
                  onClick={() => dispatch(setOpenCartPopup(!openCartPopup))}
                  className={`${
                    openCartPopup
                ...
                <div
                  ref={iconBurgerRef}
                  onClick={() => dispatch(setOpenBurger(!openBurger))}
